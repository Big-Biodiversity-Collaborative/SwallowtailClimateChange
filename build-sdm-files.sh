...
do
    ...
    FILENAME="scripts/${GENUSLOWER}_${SPECIES}-sdm.R"
    
    # Read in the template file contents into the MODELFILE variable, 
    # skipping very first line
    MODELFILE=$(cat templates/template-model-building.R | tail -n +2)
