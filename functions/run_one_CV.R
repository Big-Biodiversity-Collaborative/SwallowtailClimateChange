...
run_one_CV <- function(genus, species, rerun = TRUE, max_save = FALSE, 
  ...
  # TODO: Add body of function. Will effectively be everything in 
  # templates/template-1-CV.R
  # TODO: Do we need to source the functions folder? Probably...
...
#' Calculate evaluation metrics, so we can compare model 
# performance with other SDMs. (Note that the CBI value ENMevaluate spits out 
# is the same as what's produced with the ecospat package)
# TSS = maxTSS
