# Create an forecast distribution generating script for each species from GLM
# Jeff Oliver
...
do
    ...
    FILENAME="scripts/${GENUSLOWER}_${SPECIES}-forecast-glm.R"
    
    # Read in the template file contents into the MODELFILE variable, 
    # skipping very first line
    MODELFILE=$(cat templates/template-forecast-glm-building.R | tail -n +2)

    # Add lines at top of file explaining script & message warning against 
    # editing
    MESSAGE="# This file is auto-generated by build-forecast-files.sh. Do NOT edit."
