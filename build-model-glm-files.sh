# Create a generalized linear model SDM script for each species
# Jeff Oliver
...
do
    ...
    FILENAME="scripts/${GENUSLOWER}_${SPECIES}-model-glm.R"
    
    # Read in the template file contents into the MODELFILE variable, 
    # skipping very first line
    MODELFILE=$(cat templates/template-model-glm-building.R | tail -n +2)

    # Add lines at top of file explaining script & message warning against 
    # editing
    MESSAGE="# This file is auto-generated by build-sdm-files.sh. Do NOT edit."
    MODELFILE=$(echo -e "# GLM model for ${GENUS} ${SPECIES}\n${MESSAGE}\n${MODELFILE}")
