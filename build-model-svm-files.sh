# Create a Support Vector Machine SDM script for each species
# Jeff Oliver
...
do
    ...
    FILENAME="scripts/${GENUSLOWER}_${SPECIES}-model-svm.R"
    
    # Read in the template file contents into the MODELFILE variable, 
    # skipping very first line
    MODELFILE=$(cat templates/template-model-svm-building.R | tail -n +2)
    ...
    MODELFILE=$(echo -e "# SVM model for ${GENUS} ${SPECIES}\n${MESSAGE}\n${MODELFILE}")
